...

{
    ...
    public function reporteempleados(){
        ...
        $empleados = \DB::select("SELECT e.idemp,CONCAT(e.nombre,' ',e.apellido) AS nomc, e.correo,c.nombre AS carre,e.rfc, e.activo FROM empleados AS e INNER JOIN carreras AS c ON c.idca = e.idca ORDER BY e.nombre ASC");
...
public function editaempleado(request $request){
    ...
    e.fechanac, e.rfc, e.sexo, e.curriculom, e.idca,e.activo, c.nombre AS carre
FROM empleados AS e
